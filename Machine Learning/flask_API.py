...
def index():
    ...
    horizontal_distance_to_hydrology = int(request.form['horizontal_distance_hydrology'])
    vertical_distance_to_hydrology = int(request.form['vertical_distance_hydrology'])
    horizontal_distance_to_roadways = int(request.form['horizontal_distance_roadways'])
    ...
    horizontal_distance_to_fire_points = int(request.form['horizontal_distance_fire_points'])
